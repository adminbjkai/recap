...
class JobPaths:
    ...
    @property
    def speaker_names_json(self) -> Path:
        return self.root / "speaker_names.json"
    ...
    @property
    def frame_review_json(self) -> Path:
        return self.root / "frame_review.json"

    @property
    def transcript_notes_json(self) -> Path:
        return self.root / "transcript_notes.json"
